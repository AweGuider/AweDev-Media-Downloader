...
| --- | --- | --- |
| `yt-dlp` | `yt-dlp[default,curl-cffi]>=2026.8.19` | Unlicense. Some upstream release formats can include differently licensed bundled code; this app packages the Python package, not the standalone upstream executable. |
